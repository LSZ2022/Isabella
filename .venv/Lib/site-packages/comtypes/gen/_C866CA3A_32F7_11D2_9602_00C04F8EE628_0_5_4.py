...
__all__ = [
    'SpeechCategoryAudioIn', 'STCAll', 'SAFT24kHz8BitStereo',
    'SpeechStreamSeekPositionType', 'DISPID_SVSLastResult',
    'DISPID_SpeechWaveFormatEx', 'SRARoot', 'SPWT_LEXICAL',
    'SP_VISEME_20', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRCBookmark', 'DISPID_SPRulesCount',
    'DISPID_SPEAudioStreamOffset', 'IInternetSecurityManager',
    'ISpeechLexiconWords', 'SRTStandard',
    'DISPID_SRSCurrentStreamPosition', 'ISpShortcut',
    'DISPID_SRCRetainedAudio', '_ISpeechRecoContextEvents',
    'SRSEIsSpeaking', 'SREStreamEnd', 'DISPID_SPRNumberOfElements',
    'SpeechCategoryAppLexicons', '_ISpeechVoiceEvents',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPAO_RETAIN_AUDIO',
    'DISPID_SFSClose', 'SPRULE', 'SAFTCCITT_uLaw_22kHzMono',
    'SPEI_TTS_PRIVATE', 'DISPID_SOTGetStorageFileName',
    'SP_VISEME_12', 'SpShortcut', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SGRSTRule', 'ISequentialStream', 'SSFMOpenReadWrite',
    'DISPID_SpeechPhraseRule', 'SpInProcRecoContext',
    'SDA_Two_Trailing_Spaces', 'ISpStreamFormat',
    'SAFT48kHz16BitStereo', 'tagSTATSTG', '__MIDL_IWinTypes_0009',
    'DISPID_SWFEExtraData', 'SPEI_SOUND_END', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechAudioFormat', 'DISPID_SPPsItem',
    'ISpeechGrammarRules', 'DISPID_SRCRecognizer', 'SDTRule',
    'SSTTTextBuffer', 'SPPHRASEPROPERTY',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRDisplayUI',
    'SAFT44kHz8BitStereo', 'DISPID_SVSRunningState', 'IStream',
    'SPGS_ENABLED', 'DISPID_SpeechObjectTokens',
    'ISpeechPhraseReplacements', 'DISPID_SRGDictationUnload',
    'DISPID_SRGCmdLoadFromFile', 'SRSActiveAlways', 'DISPID_SAFGuid',
    'DISPID_SGRsAdd', 'DISPID_SPRuleFirstElement',
    'SAFT8kHz16BitMono', 'SPAS_RUN', 'SpAudioFormat',
    'DISPID_SRCEInterference', 'SPPS_Unknown', 'ISpNotifySource',
    'SPPS_Modifier', 'eLEXTYPE_USER', 'SRAONone',
    'SPSHT_NotOverriden', 'DISPID_SPCLangId',
    'SPEI_RECO_OTHER_CONTEXT', 'SPCT_SUB_COMMAND',
    'DISPID_SDKSetLongValue', 'DISPID_SRRAudio',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRCCreateGrammar',
    'DISPID_SRProfile', 'IEnumString', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SVGetAudioInputs', 'STSF_AppData', 'DISPID_SLPLangId',
    'DISPID_SBSWrite', 'SPSMF_SRGS_SAPIPROPERTIES', 'SREStreamStart',
    'SPAUDIOBUFFERINFO', 'DISPID_SDKOpenKey', 'SECFIgnoreWidth',
    'DISPID_SpeechLexiconPronunciation', 'SAFT8kHz8BitStereo',
    'SRTAutopause', 'DISPID_SVAlertBoundary', 'IEnumSpObjectTokens',
    'DISPID_SVDisplayUI', 'SpeechRunState', 'DISPID_SRIsUISupported',
    'SPCT_SUB_DICTATION', 'SVEWordBoundary', 'eLEXTYPE_PRIVATE19',
    'SRERequestUI', 'SPSFunction', 'SAFT12kHz8BitStereo',
    'SPWF_INPUT', 'DISPID_SRGReset', 'SGDSActiveUserDelimited',
    'DISPID_SpeechPhraseElement', 'DISPID_SRCreateRecoContext',
    'SECFIgnoreKanaType', 'SREBookmark', 'SPFM_OPEN_READONLY',
    'SREStateChange', 'DISPID_SRGIsPronounceable', 'SPSVerb',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVWaitUntilDone',
    'SECFDefault', 'DISPID_SGRSTType', 'ISpeechPhoneConverter',
    'SVP_10', 'DISPID_SpeechLexiconProns', 'SAFT22kHz16BitStereo',
    'DISPID_SpeechFileStream', 'DISPID_SRStatus',
    'DISPID_SPPs_NewEnum', 'SPAO_NONE', 'SVPAlert', 'SRAORetainAudio',
    'SDTAll', 'DISPID_SPIStartTime', 'SAFTCCITT_uLaw_22kHzStereo',
    'SVPNormal', 'eLEXTYPE_PRIVATE20',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRRAlternates',
    'DISPID_SpeechAudio', 'eLEXTYPE_RESERVED6', 'ISpRecoGrammar2',
    'DISPID_SRCESoundStart', 'ISpeechMMSysAudio',
    'DISPID_SVSVisemeId', 'SDA_No_Trailing_Space',
    'SpeechPropertyComplexResponseSpeed', 'eLEXTYPE_RESERVED8',
    'SVP_1', 'ISpeechWaveFormatEx', 'DISPID_SPCIdToPhone',
    'SPAUDIOOPTIONS', 'SpeechLexiconType', 'ISpNotifySink',
    'DISPID_SRCEHypothesis', 'DISPID_SPEEngineConfidence',
    'DISPID_SMSAMMHandle', 'SPWORDLIST', 'WAVEFORMATEX',
    'SPEI_RESERVED1', 'SREAudioLevel', 'SAFT44kHz16BitStereo',
    'SpeechRetainedAudioOptions', 'DISPID_SRGRecoContext',
    'ISpeechPhraseAlternates', 'DISPID_SPIAudioSizeBytes', 'SINoise',
    'SPBO_PAUSE', 'SPEI_FALSE_RECOGNITION', 'SPVISEMES',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SGRClear',
    'DISPID_SRRRecoContext', 'SpeechVoiceSkipTypeSentence',
    'ISpSerializeState', 'DISPID_SPEAudioTimeOffset', 'SASClosed',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRRecognizer',
    'SPINTERFERENCE_TOOFAST', 'SVP_14', 'SPEI_START_INPUT_STREAM',
    'SPSModifier', 'DISPID_SRGCommit', 'SPAUDIOSTATUS',
    'SPDKL_LocalMachine', 'ISpObjectToken',
    'DISPID_SRCRetainedAudioFormat', 'SPPS_LMA', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPPChildren', 'DISPID_SLPsCount',
    'SAFTCCITT_ALaw_44kHzStereo', 'SDKLCurrentConfig', 'SVP_0',
    'DISPID_SRCEPropertyNumberChange', 'SPSTREAMFORMATTYPE',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpeechTextSelectionInformation', 'SpeechAllElements',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPPS_Verb',
    'DISPID_SpeechRecognizerStatus', 'SAFTCCITT_ALaw_44kHzMono',
    'eLEXTYPE_RESERVED7', 'DISPID_SOTs_NewEnum', 'SPDKL_CurrentUser',
    'SDTAlternates', 'DISPID_SABIBufferSize',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT11kHz16BitMono', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRCVoicePurgeEvent', 'SAFTADPCM_11kHzStereo',
    'SVEStartInputStream', 'SPEI_UNDEFINED', 'DISPID_SPRText',
    'SAFT24kHz16BitStereo', 'SPPS_RESERVED2',
    'SpeechVoiceCategoryTTSRate', 'SPSERIALIZEDPHRASE', 'DISPIDSPRG',
    'DISPID_SPIReplacements', 'SPPHRASEREPLACEMENT',
    'tagSPTEXTSELECTIONINFO', 'SpeechRecoProfileProperties',
    'SREPropertyNumChange', 'ISpRecognizer2',
    'ISpObjectTokenCategory', 'SECFNoSpecialChars', 'SINone',
    'SPPHRASE', 'SpStream', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPRsCount', 'SBONone', 'SAFT22kHz8BitStereo',
    'SP_VISEME_9', 'DISPID_SpeechPhraseReplacements', 'SP_VISEME_13',
    'SVP_5', 'SPFM_OPEN_READWRITE', 'SpeechRegistryUserRoot',
    'SP_VISEME_21', 'SPSEMANTICFORMAT', 'DISPID_SVEViseme',
    'Speech_StreamPos_RealTime', 'DISPID_SPPName', 'SPAR_Medium',
    'SITooQuiet', 'DISPID_SASNonBlockingIO', 'SP_VISEME_14',
    'DISPID_SRCESoundEnd', 'DISPID_SGRSRule',
    'DISPID_SRCSetAdaptationData', 'eLEXTYPE_PRIVATE2',
    'SREPhraseStart', 'eLEXTYPE_PRIVATE15',
    ...
    'STSF_FlagCreate', 'SPRS_ACTIVE_USER_DELIMITED', 'ISpMMSysAudio',
    'SPWORDPRONUNCIATION', 'DISPID_SRAudioInput',
    'SPRECOCONTEXTSTATUS', 'SpeechRuleAttributes', 'SPEI_MAX_SR',
    'DISPID_SLPs_NewEnum', 'SRSInactiveWithPurge',
    'SpeechGrammarState', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCState', 'DISPID_SGRSTPropertyName', 'DISPID_SRCPause',
    'SP_VISEME_2', 'SpeechPropertyHighConfidenceThreshold',
    'eLEXTYPE_PRIVATE7', 'DISPID_SAFSetWaveFormatEx',
    'SWPUnknownWordPronounceable', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVSInputWordLength', 'SPEI_REQUEST_UI', 'SP_VISEME_3',
    'SpeechAudioState', 'SPRST_INACTIVE_WITH_PURGE',
    '_RemotableHandle', 'DISPID_SASState', 'SRAImport', 'SPRULESTATE',
    'DISPID_SRCEBookmark', 'SVP_16', 'DISPID_SVSInputSentenceLength',
    'SpeechGrammarWordType', 'SpeechPartOfSpeech',
    'ISpeechGrammarRuleState', 'DISPID_SRGetRecognizers',
    'SPEI_WORD_BOUNDARY', 'DISPID_SGRsItem', 'DISPID_SRRAudioFormat',
    'DISPID_SRState', 'SpeechAudioProperties',
    'SPADAPTATIONRELEVANCE', 'DISPID_SPPNumberOfElements',
    'SPPS_NotOverriden', 'ISpGrammarBuilder', 'DISPID_SGRSTNextState',
    'SPPHRASEELEMENT', 'UINT_PTR', 'DISPID_SLWsCount',
    'SPPS_RESERVED4', 'DISPID_SPEPronunciation', 'SpeechUserTraining',
    'DISPID_SOTDataKey', 'DISPID_SGRSTsCount',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SVEBookmark',
    'DISPID_SGRsCount', 'DISPID_SpeechAudioStatus', 'SBOPause',
    'SLOStatic', 'DISPID_SBSRead', 'DISPID_SRCEEnginePrivate',
    'DISPID_SVSInputSentencePosition', 'DISPID_SRGDictationLoad',
    'SPEI_RESERVED5', 'DISPID_SOTsItem', 'DISPID_SVEAudioLevel',
    'SPWF_SRENGINE', 'SVF_Stressed', 'SAFT22kHz8BitMono', 'SASStop',
    'ISpeechVoice', 'eLEXTYPE_PRIVATE11',
    'DISPID_SPRuleNumberOfElements', 'SGDSActive',
    'DISPID_SPIAudioSizeTime', 'ISpPhoneticAlphabetConverter',
    'DISPIDSPTSI_ActiveLength', 'SVP_8', 'DISPID_SRGId',
    'SAFTADPCM_11kHzMono', 'SPGRAMMARWORDTYPE', 'SPVPRI_OVER',
    'SECNormalConfidence', 'DISPID_SOTCategory', 'SGSDisabled',
    ...
    'DISPID_SPIAudioStreamPosition', 'ISpRecoContext2',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPRsItem',
    'ISpeechLexiconPronunciations', 'DISPID_SPRs_NewEnum',
    'DISPID_SGRId', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechPhoneConverter',
    'SpeechPropertyResourceUsage', 'DISPID_SRRTStreamTime',
    'SpeechTokenShellFolder', 'DISPID_SOTSetId', 'DISPID_SPAsItem',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SABufferNotifySize', 'SPEI_SR_RETAINEDAUDIO',
    'SPWORDPRONOUNCEABLE', 'DISPID_SWFESamplesPerSec',
    'SpeechAudioFormatGUIDWave', 'ISpPhoneConverter', 'SRCS_Enabled',
    'DISPIDSPTSI_ActiveOffset', 'SITooFast',
    'DISPID_SGRSTPropertyValue', 'SPBO_AHEAD', 'DISPID_SPPParent',
    'DISPID_SpeechPhraseElements', 'DISPID_SRRSetTextFeedback',
    'DISPID_SAVolume', 'DISPID_SVESentenceBoundary',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_HYPOTHESIS',
    'DISPID_SPIGetText', 'SVEVoiceChange', 'SECLowConfidence',
    ...
    'DISPID_SLPPartOfSpeech', 'SPSHT_Unknown',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SVEventInterests',
    'SpPhoneConverter', 'DISPID_SBSSeek', 'SLTUser', 'SVSFIsFilename',
    'SpeechStreamFileMode', 'ISpAudio', 'DISPIDSPTSI',
    'DISPID_SRCERecognition', 'tagSPPROPERTYINFO',
    'DISPID_SpeechPhraseRules', 'SPWT_PRONUNCIATION',
    'SpUnCompressedLexicon', 'SPSHT_EMAIL', 'SGLexical',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpeechLoadOption',
    'SpeechRecognizerState', 'SpeechRuleState', 'DISPID_SVPriority',
    'ISpeechPhraseAlternate', 'DISPID_SABIMinNotification',
    'DISPID_SVEStreamStart', 'SpeechTokenContext', 'SPBINARYGRAMMAR',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechVoiceStatus', 'SAFT32kHz16BitMono', 'SRSEDone',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SWFEChannels',
    'DISPID_SRRSpeakAudio', 'SpeechVoicePriority',
    'DISPID_SVSInputWordPosition', 'SPXRO_Alternates_SML',
    'SDKLDefaultLocation', 'ISpRecognizer3', 'DISPID_SPIProperties',
    'SVSFParseAutodetect', 'SPEI_RESERVED3', 'DISPID_SLGenerationId',
    'STCRemoteServer', 'DISPID_SLPsItem', 'SPPS_Noun',
    'SDTLexicalForm', 'SDA_Consume_Leading_Spaces', 'SDKLCurrentUser',
    'DISPID_SPRuleChildren', 'SpeechAudioVolume',
    'DISPID_SpeechRecoResult', 'ISpDataKey', 'DISPID_SGRs_NewEnum',
    'DISPID_SASFreeBufferSpace', 'SGRSTTDictation',
    'DISPID_SpeechDataKey', 'DISPID_SPPsCount', 'SVP_13',
    'SPSHORTCUTPAIRLIST', 'DISPID_SBSFormat', 'DISPID_SVStatus',
    'DISPID_SPEDisplayAttributes', 'DISPID_SOTCDefault',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPELexicalForm',
    'DISPID_SGRSTText', 'DISPID_SWFEFormatTag', 'DISPID_SLPType',
    'DISPID_SPRulesItem', 'SRERecoOtherContext',
    'DISPID_SRSAudioStatus', 'DISPID_SRSClsidEngine',
    'DISPID_SVSpeakCompleteEvent', 'SPINTERFERENCE_NOISE',
    'SAFTGSM610_44kHzMono', 'DISPID_SCSBaseStream', 'STCInprocServer',
    'SAFT32kHz16BitStereo', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRRTimes', 'ISpeechPhraseProperties',
    'DISPID_SpeechVoiceEvent', 'ISpeechFileStream',
    'SpeechDictationTopicSpelling', 'SPEI_END_SR_STREAM',
    'ISpeechObjectTokens', 'DISPID_SRCVoice', 'SPRST_NUM_STATES',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRAttributes',
    'ISpPhoneticAlphabetSelection', 'DISPID_SMSGetData',
    'DISPID_SRGDictationSetState', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SpeechObjectToken',
    'SAFT16kHz8BitMono', 'SREInterference', 'SpeechTokenKeyFiles',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRCEAdaptation',
    'SVP_17', 'SpeechVisemeType', 'DISPID_SPEAudioSizeTime',
    'ISpeechObjectTokenCategory', 'ISpPhraseAlt', 'eLEXTYPE_PRIVATE9',
    'SVP_2', 'DISPID_SLWPronunciations', 'SVP_12', 'DISPID_SOTsCount',
    'DISPID_SGRAddResource', 'SAFTNoAssignedFormat',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SDKDeleteValue', 'SPWORD',
    'SpMemoryStream', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRCEFalseRecognition', 'SPINTERFERENCE',
    'SAFT8kHz8BitMono', 'SpeechDataKeyLocation', 'DISPID_SLWsItem',
    'ISpeechRecoResult2', 'DISPID_SRCRequestedUIType',
    'SAFTCCITT_ALaw_22kHzMono', '_SPAUDIOSTATE', 'SVEEndInputStream',
    'DISPID_SVGetProfiles', 'DISPID_SPERequiredConfidence',
    'SPPHRASERULE', 'DISPID_SMSSetData', 'SpeechTokenValueCLSID',
    'SAFT44kHz8BitMono', 'ISpeechPhraseProperty', 'eLEXTYPE_PRIVATE3',
    'SPEI_SR_PRIVATE', 'SGLexicalNoSpecialChars', 'ISpRecoGrammar',
    'SAFTCCITT_ALaw_8kHzStereo', 'LONG_PTR', 'SPEI_TTS_AUDIO_LEVEL',
    'eLEXTYPE_PRIVATE16', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechLexiconWords', 'SpeechAudioFormatGUIDText',
    'SRCS_Disabled', 'ISpRecognizer', 'SAFT48kHz16BitMono',
    'DISPID_SVSLastBookmarkId', 'SAFTCCITT_ALaw_8kHzMono',
    'SPEVENTSOURCEINFO', 'SpeechInterference', 'SGPronounciation',
    'ISpRecoCategory', 'SSFMOpenForRead', 'SPEI_PHRASE_START',
    'SVP_11', 'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechRecoResult2',
    'SDTPronunciation', 'SVSFNLPMask',
    'DISPID_SVSyncronousSpeakTimeout',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'Speech_Default_Weight',
    'SAFTText', 'eLEXTYPE_RESERVED9', 'SREAdaptation', 'SPRECOSTATE',
    'DISPID_SDKGetStringValue', 'SVEAudioLevel', 'SPSHORTCUTPAIR',
    'ISpeechGrammarRule', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SABIEventBias', 'ISpeechLexicon',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SpeechRecoResultTimes',
    'ISpeechResourceLoader', 'DISPID_SRRSaveToMemory', 'SVP_4',
    'DISPID_SPRuleName', 'SRSActive', 'DISPID_SOTIsUISupported',
    'SpWaveFormatEx', 'DISPID_SOTGetAttribute', 'SAFT24kHz16BitMono',
    'SpeechTokenKeyAttributes', 'SPRST_ACTIVE_ALWAYS',
    'ISpRecoResult', 'SPGS_EXCLUSIVE', 'SPWT_DISPLAY',
    'DISPID_SRSetPropertyString', 'ISpeechPhraseRules', 'SP_VISEME_5',
    'SVF_None', 'DISPID_SLWType', 'SAFT32kHz8BitMono',
    'DISPID_SGRName', 'SpeechWordType', 'SPAR_Low',
    'SAFT16kHz16BitStereo', 'DISPID_SLGetWords', 'ISpEventSink',
    'SVEPrivate', 'ISpPhrase', 'SPBO_TIME_UNITS', 'SECFEmulateResult',
    'SP_VISEME_0', 'ISpeechPhraseElement', 'DISPID_SRRTTickCount',
    'DISPID_SLAddPronunciation', 'SAFT12kHz8BitMono',
    'SpeechVisemeFeature', 'SPWORDTYPE', 'SPSERIALIZEDRESULT',
    'DISPID_SFSOpen', 'SAFTDefault', 'SWTDeleted',
    'DISPID_SRRTLength', 'ISpeechRecoResultDispatch',
    'DISPID_SPIRule', 'SRTReSent', 'DISPID_SDKEnumKeys',
    'DISPID_SPRFirstElement', 'SpeechFormatType', 'SRTEmulated',
    'SRERecognition', 'SPTEXTSELECTIONINFO',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRCResume',
    'ISpeechAudioStatus', 'DISPID_SAStatus',
    'SPWORDPRONUNCIATIONLIST', 'SpeechGrammarTagWildcard',
    'SPVPRI_NORMAL', 'SpeechWordPronounceable',
    'DISPID_SPEDisplayText', 'SPSUnknown',
    'DISPID_SRCEPropertyStringChange', 'SP_VISEME_11',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_7',
    'DISPID_SPPId', 'SVSFVoiceMask', 'SVP_18', 'DISPID_SPARecoResult',
    'SGRSTTTextBuffer', 'SPSSuppressWord', 'SPPARTOFSPEECH',
    'SpeechSpecialTransitionType', 'DISPID_SGRSAddRuleTransition',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRAudioInputStream',
    'DISPID_SPEAudioSizeBytes', 'SPEI_RESERVED2',
    'DISPID_SDKGetBinaryValue', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPAS_CLOSED', 'DISPID_SpeechRecognizer', 'ISpProperties',
    'STSF_CommonAppData', 'SPEI_RECOGNITION', 'eLEXTYPE_PRIVATE5',
    'SAFT32kHz8BitStereo', 'DISPID_SPISaveToMemory', 'SVP_20',
    'DISPID_SVPause', 'DISPID_SpeechLexiconWord', 'SPPS_Noncontent',
    'SRTSMLTimeout', 'SAFT48kHz8BitMono',
    'DISPID_SRGCmdLoadFromMemory', 'SPBO_NONE', 'DISPID_SOTId',
    'eLEXTYPE_APP', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVP_21',
    'STSF_LocalAppData', 'SPDKL_CurrentConfig', 'DISPID_SPPValue',
    'ISpeechXMLRecoResult', 'SPLO_STATIC', 'DISPID_SRCEPhraseStart',
    'ISpeechRecognizerStatus', 'SpeechRecognitionType',
    'DISPID_SADefaultFormat', 'DISPID_SAEventHandle',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRCERecognizerStateChange',
    'SGRSTTWildcard', 'SpMMAudioEnum', 'DISPID_SGRSTransitions',
    'SGDSActiveWithAutoPause', 'SAFT24kHz8BitMono', 'DISPID_SVResume',
    'DISPID_SMSADeviceId', 'DISPID_SVEWord',
    ...
    'SPDKL_DefaultLocation', 'SpeechRecoEvents', 'SPSNotOverriden',
    'DISPID_SPRuleId', 'SVESentenceBoundary', 'SITooSlow',
    'ISpeechAudioBufferInfo', 'SPCT_DICTATION', 'SREFalseRecognition',
    'ISpStreamFormatConverter', 'DISPID_SRGetFormat',
    'SpPhraseInfoBuilder', 'SpeechRegistryLocalMachineRoot',
    'SVSFParseMask', 'SpCustomStream',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechPhraseElements',
    'SPCS_DISABLED', 'DISPID_SpeechPhraseProperties',
    'ISpeechRecognizer', 'SVEViseme', 'DISPID_SWFEBlockAlign',
    'SAFT16kHz16BitMono', 'SRESoundStart', 'SPAR_Unknown',
    'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRSNumberOfActiveRules', 'SP_VISEME_17',
    'SpeechVoiceSpeakFlags', 'SpStreamFormatConverter',
    'SPPS_SuppressWord', 'SVP_6', 'SAFTADPCM_22kHzMono',
    'eWORDTYPE_ADDED', 'SRSInactive', 'DISPID_SVSkip',
    'DISPID_SPPFirstElement', 'DISPID_SpeechBaseStream',
    'eLEXTYPE_PRIVATE4', 'DISPID_SLWWord',
    'DISPID_SVAudioOutputStream', 'SPEI_VISEME', 'SPLO_DYNAMIC',
    'SVPOver', 'SAFTADPCM_22kHzStereo', 'SREPrivate',
    'SPFM_CREATE_ALWAYS', 'SP_VISEME_16', 'SSFMCreateForWrite',
    'DISPID_SVEVoiceChange', 'SPEI_TTS_BOOKMARK', 'SPRECORESULTTIMES',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPRules_NewEnum',
    'ISpeechDataKey', 'DISPID_SOTDisplayUI', 'SPCT_SLEEP',
    'DISPID_SpeechLexicon', 'SRAInterpreter', 'SVEPhoneme',
    'SpLexicon', 'SREAllEvents', 'SpeechAudioFormatType',
    'SAFTNonStandardFormat', 'SPEI_SOUND_START', 'SGRSTTWord',
    'SP_VISEME_4', 'SpeechPropertyLowConfidenceThreshold',
    'SPCONTEXTSTATE', 'SAFTADPCM_44kHzStereo', 'eLEXTYPE_RESERVED4',
    'DISPID_SPRuleEngineConfidence', 'SpeechPropertyAdaptationOn',
    'ISpLexicon', 'SAFT8kHz16BitStereo', 'ISpeechAudio',
    'DISPID_SPRuleConfidence', 'SpVoice', 'DISPID_SGRSTWeight',
    'Speech_Max_Word_Length', 'SpeechEngineProperties',
    'SAFTGSM610_22kHzMono', 'SPSHORTCUTTYPE', 'ISpeechCustomStream',
    'DISPID_SpeechGrammarRules', 'SpeechEngineConfidence',
    'DISPID_SPIGrammarId', 'DISPID_SPIElements', 'SPEI_MIN_TTS',
    'DISPID_SpeechVoice', 'SPVOICESTATUS', 'SVSFIsXML',
    'DISPID_SGRsFindRule', 'SAFT12kHz16BitStereo',
    'DISPID_SPPEngineConfidence', 'SP_VISEME_6',
    'DISPID_SWFEAvgBytesPerSec', 'ISpStream', 'ISpeechMemoryStream',
    'DISPID_SRGCmdLoadFromObject', 'SpeechDisplayAttributes',
    'SPSNoun', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SPACommit',
    'Speech_Max_Pron_Length', 'eLEXTYPE_PRIVATE14', 'SVSFPersistXML',
    'SPSHT_OTHER', 'DISPID_SVVoice', 'DISPID_SGRSTPropertyId',
    'DISPID_SOTCreateInstance', 'DISPID_SPAsCount',
    'ISpNotifyTranslator', 'SVSFParseSsml', 'SPAR_High',
    'SpeechDiscardType', 'SAFT22kHz16BitMono', 'SAFT44kHz16BitMono',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SLGetPronunciations',
    'SGSExclusive', 'SpCompressedLexicon', 'DISPID_SRGState',
    'DISPID_SAFGetWaveFormatEx', 'SpPhoneticAlphabetConverter',
    'SVP_7', 'SLODynamic', 'SPFM_CREATE', 'SVP_19', 'SASPause',
    'SP_VISEME_18', 'DISPID_SPPConfidence', 'SpeechVoiceEvents',
    'SDA_One_Trailing_Space', 'SAFT11kHz8BitMono',
    'SpeechTokenIdUserLexicon', 'SPVPRIORITY',
    'SWPKnownWordPronounceable', 'ISpeechBaseStream', 'SPCS_ENABLED',
    'DISPID_SpeechRecoContext', 'DISPID_SGRsCommit',
    'DISPID_SABufferInfo', 'DISPID_SPCPhoneToId',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPEI_VOICE_CHANGE',
    'DISPID_SVSPhonemeId', 'SVP_15', 'eLEXTYPE_RESERVED10',
    'ISpXMLRecoResult', 'DISPID_SVGetVoices', 'SPEVENTENUM',
    'DISPID_SDKSetBinaryValue', 'DISPID_SDKCreateKey',
    'DISPID_SRGetPropertyNumber', 'SpSharedRecognizer', 'SWTAdded',
    'DISPID_SPAStartElementInResult', 'ISpeechObjectToken',
    ...
    'ISpeechPhraseRule', 'DISPID_SVEPhoneme',
    'DISPID_SRGSetTextSelection', 'ISpeechLexiconPronunciation',
    'SVSFNLPSpeakPunc', 'DISPID_SOTGetDescription',
    'SPINTERFERENCE_TOOQUIET', 'ISpeechRecoGrammar', 'SPRST_ACTIVE',
    'SPGRAMMARSTATE', 'SAFTExtendedAudioFormat', 'SAFT12kHz16BitMono',
    'SDTReplacement', 'SGSEnabled', 'eLEXTYPE_PRIVATE17',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVP_9', 'SAFTGSM610_8kHzMono',
    'DISPID_SPILanguageId', 'DISPID_SGRInitialState', 'SVSFIsNotXML',
    'SVSFParseSapi', 'SITooLoud', 'SPPROPERTYINFO', 'SECFIgnoreCase',
    'SpeechCategoryRecognizers', 'DISPID_SVSpeak',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SVRate', 'SGRSTTEpsilon',
    'SGRSTTRule', 'SpeechTokenKeyUI', 'Speech_StreamPos_Asap',
    'DISPID_SDKDeleteKey', 'DISPID_SPEsItem', 'eLEXTYPE_PRIVATE1',
    'SAFT11kHz8BitStereo', 'SpeechGrammarTagDictation',
    'DISPID_SOTMatchesAttributes', 'SpeechRecoContextState',
    'DISPID_SGRAddState', 'SPSLMA', 'DISPID_SLRemovePronunciation',
    'SAFTCCITT_uLaw_11kHzMono', 'SRAExport',
    'DISPID_SpeechPhraseReplacement', 'SAFTADPCM_44kHzMono',
    'SRADefaultToActive', 'DISPID_SRCEEndStream',
    'SpeechCategoryRecoProfiles', 'DISPID_SRCCmdMaxAlternates',
    'SSTTWildcard', 'SPXMLRESULTOPTIONS', 'DISPID_SpeechPhraseInfo',
    'ISpeechRecoContext', 'SPEI_MIN_SR',
    'DISPID_SRSSupportedLanguages', 'DISPID_SOTRemove',
    'DISPID_SASetState', 'SVSFlagsAsync', 'DISPID_SLWLangId',
    'DISPID_SLPSymbolic', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SVSLastBookmark', 'SVSFPurgeBeforeSpeak',
    'SDTDisplayText', 'SPFILEMODE', 'ISpEventSource', 'SPCT_COMMAND',
    'DISPID_SOTCId', 'DISPID_SGRsDynamic', 'SFTInput',
    'DISPID_SRCEStartStream', 'SLTApp', 'SPVPRI_ALERT',
    'SPEI_START_SR_STREAM', 'SPPS_RESERVED1', 'SDKLLocalMachine',
    'SRATopLevel', 'eLEXTYPE_PRIVATE8', 'eLEXTYPE_MORPHOLOGY',
    'SPRS_INACTIVE', 'DISPID_SRSetPropertyNumber',
    'DISPID_SVEStreamEnd', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVVolume',
    'SSSPTRelativeToStart', 'SVSFUnusedFlags', 'SPRS_ACTIVE',
    'DISPID_SPAPhraseInfo', 'SREHypothesis', 'SpInprocRecognizer',
    'DISPID_SOTRemoveStorageFileName', 'STCInprocHandler',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRGRules', 'SPEI_INTERFERENCE',
    'SPEVENT', 'ISpeechPhraseInfo', 'eLEXTYPE_PRIVATE10',
    'SPINTERFERENCE_NONE', 'SpeechCategoryAudioOut',
    'DISPID_SLPPhoneIds', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRRGetXMLErrorInfo', 'ISpVoice', 'eWORDTYPE_DELETED',
    'SPEI_MAX_TTS', 'DISPID_SOTCEnumerateTokens', 'SPEI_ADAPTATION',
    'SpeechMicTraining', 'ISpeechRecoResult',
    ...
    'STCLocalServer', 'SpNotifyTranslator', 'SDTProperty',
    'DISPID_SPEsCount', 'SpObjectToken', 'SPCATEGORYTYPE', 'SVP_3',
    'SSFMCreate', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPPS_RESERVED3', 'ISpeechPhraseInfoBuilder', 'SINoSignal',
    'SSTTDictation', 'DISPID_SASCurrentDevicePosition', 'SP_VISEME_8',
    'SAFTADPCM_8kHzMono', 'DISPID_SPRDisplayAttributes',
    'DISPID_SVIsUISupported',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPEI_RESERVED6', 'SPGS_DISABLED', 'SDTAudio',
    'SPDATAKEYLOCATION', 'eLEXTYPE_USER_SHORTCUT', 'SVSFDefault',
    'SP_VISEME_10', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRSCurrentStreamNumber', 'SREPropertyStringChange',
    'SP_VISEME_19', 'SVF_Emphasis', 'SPAUDIOSTATE', 'ISpRecoContext',
    'SpeechGrammarTagUnlimitedDictation', 'SPRECOGNIZERSTATUS',
    'SPAS_PAUSE', 'SGDisplay', 'DISPID_SMSALineId',
    ...
    'SAFTCCITT_uLaw_44kHzStereo', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SLWs_NewEnum', 'DISPID_SpeechMemoryStream', 'SP_VISEME_1',
    'SASRun', 'DISPID_SPIEngineId', 'SGDSInactive',
    'SAFT16kHz8BitStereo', 'DISPID_SpeechMMSysAudio',
    'SPWAVEFORMATTYPE', 'DISPID_SDKSetStringValue', 'DISPID_SAFType',
    'SWPUnknownWordUnpronounceable', 'SPFM_NUM_MODES', 'SVEBookmark',
    'SPSMF_UPS', 'SPAS_STOP', 'DISPID_SPRuleParent',
    'SpeechEmulationCompareFlags', 'ISpObjectWithToken',
    'SSSPTRelativeToEnd', 'SpeechCategoryPhoneConverters',
    ...
    'DISPID_SGRSAddWordTransition', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpMMAudioIn', 'DISPID_SGRSTs_NewEnum', 'SpObjectTokenCategory',
    'ISpeechPhraseReplacement', 'SPSInterjection',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpNullPhoneConverter',
    'ISpResourceManager', 'SpMMAudioOut', 'eLEXTYPE_PRIVATE13',
    'SFTSREngine', 'SRADynamic', 'SPLOADOPTIONS', 'SECHighConfidence',
    'SPLEXICONTYPE', 'ISpeechAudioFormat', 'SPXRO_SML',
    'SPEI_PHONEME', 'SRESoundEnd', 'SpeechPropertyResponseSpeed',
    'DISPID_SpeechGrammarRule', 'SRTExtendableParse',
    'ISpeechVoiceStatus', 'DISPID_SPEs_NewEnum', 'DISPID_SRIsShared',
    'SVEAllEvents', 'SPPS_Function', 'eLEXTYPE_PRIVATE12',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SpeechPhraseAlternate'
]

_check_version('1.1.14', 1721960978.499781)
